        ...
        <div className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl">
          ...
          <div className="space-y-2 mb-8">
            <div className="flex items-center gap-2 text-white/80">
              ...
              <span className="text-sm">Case studies saving clients $20K-$136K annually</span>
            </div>
            <div className="flex items-center gap-2 text-white/80">
              <span className="text-brand-blue">✓</span>
              <span className="text-sm">Actionable automation tips you can use today</span>
            </div>
            <div className="flex items-center gap-2 text-white/80">
              <span className="text-brand-blue">✓</span>
              <span className="text-sm">Tool recommendations from real implementations</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={status === 'loading' || status === 'success'}
              className="w-full px-6 py-4 rounded-2xl bg-brand-blue text-white font-semibold text-[1.05rem] shadow-[0_0_30px_rgba(0,112,243,0.4)] hover:translate-y-[-2px] hover:shadow-[0_0_40px_rgba(0,112,243,0.6)] transition-all duration-400 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
