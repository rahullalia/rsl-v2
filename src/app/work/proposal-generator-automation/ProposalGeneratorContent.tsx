...
export default function ProposalGeneratorContent() {
    ...
    return (
        <CaseStudyLayout
            ...
            description="RSL/A automated proposal creation with AI, reducing production time from 2 hours to 10 minutes per proposal. Built with Make.com, Claude AI, and Google Docs, this internal tool eliminated manual formatting work and recovered 165 hours annually."
            stats={stats}
        >
            ...
            <div className="proof-box">
                ...
                <p>
                    ...
                    </strong> Automation platform connecting all systems
                </p>
                <p>
