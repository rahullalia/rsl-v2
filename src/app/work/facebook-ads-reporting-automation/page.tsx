...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'How we automated a 4-hour daily Facebook Ads reporting process down to 10 minutes using Google Sheets and custom scripts, saving $18K annually and boosting conversions by 4%.',
    url: 'https://www.rsla.io/work/facebook-ads-reporting-automation',
    siteName: 'RSL/A',
    type: 'article',
  },
};

export default function FacebookAdsReportingAutomationPage() {
  const stats = [
  ...
  return (
    <CaseStudyLayout
      ...
      title="Facebook Ads Reporting Automation Saves 990+ Hours Annually"
      subtitle="A growing digital marketing agency was losing nearly 4 hours every day to manual Facebook Ads data tracking. We built a Google Sheets automation system with custom scripts that reduced this to 10 minutes, freeing up the lead marketer to focus on strategy and client growth."
      stats={stats}
    >
