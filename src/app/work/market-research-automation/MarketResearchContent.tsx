...
export default function MarketResearchContent() {
    ...
    return (
        <CaseStudyLayout
            ...
            description="One of the region's largest readership surveys was buried under a 4-month manual data collection process requiring 80 staff members. We built a high-throughput automation platform with distributed web scraping and OCR on AWS, cutting the process down to 2 weeks and saving $136,000 annually."
            stats={stats}
        >
