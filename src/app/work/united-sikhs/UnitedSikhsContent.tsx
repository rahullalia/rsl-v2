...
export default function UnitedSikhsContent() {
    const stats = [
    ...
    return (
        <CaseStudyLayout
            ...
            description="United Sikhs, a global humanitarian nonprofit, was managing 2,000+ volunteers across fragmented spreadsheets and email lists. We unified their entire volunteer database and automated onboarding workflows, eliminating the need for a full-time coordinator position and saving $40,000 annually."
            stats={stats}
        >
