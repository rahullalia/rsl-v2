...
export default function EmailIceBreakerContent() {
    ...
    return (
        <CaseStudyLayout
            ...
            description="RSL/A automated cold email personalization with AI, reducing research and writing time from 8 minutes to 30 seconds per email. Built with Make.com, OpenAI, and Google Sheets, this internal tool uses LinkedIn enrichment data to generate highly personalized icebreakers at scale."
            stats={stats}
        >
