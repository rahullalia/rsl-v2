...
export default function EmailAutoresponderContent() {
    ...
    return (
        <CaseStudyLayout
            ...
            description="RSL/A built an intelligent AI email auto-responder that reads incoming messages and generates personalized replies in seconds. Unlike generic auto-replies, this system references specific details from each inquiry, making leads feel heard even when responses are automated."
            stats={stats}
        >
