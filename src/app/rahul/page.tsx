...
export const metadata: Metadata = {
  title: 'Rahul Lalia - Founder & CEO, RSL/A',
  description: 'Connect with Rahul Lalia, Founder & CEO of RSL/A. Expert in AI automation, marketing systems, and business growth.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function RahulContactPage() {
  ...
  const smsMessage = encodeURIComponent(
    "Hi Rahul, I'd like to connect with you."
  );
    ...
    <main className="min-h-screen bg-[#050505] flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        <div className="bg-white/5 border border-white/10 rounded-[24px] p-8 text-center backdrop-blur-md">
          ...
          <div className="mb-6">
            <div className="relative w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-brand-blue/20">
              <Image
                ...
                alt="Rahul Lalia, Founder & CEO of RSL/A"
                width={128}
                height={128}
          ...
          {/* Name & Title */}
          <h1 className="text-[2rem] font-bold text-white mb-2 leading-tight font-display">
            {contactInfo.name}
          </h1>
          <p className="text-[1.1rem] text-brand-blue font-semibold mb-2">
            {contactInfo.title}
          </p>
          <p className="text-gray-400 text-sm mb-8">
            Marketing & AI Automation Expert
          </p>
          ...
          <div className="space-y-4 mb-8">
            <a
              ...
              download="Rahul-Lalia.vcf"
              className="block w-full bg-brand-blue text-white px-6 py-4 rounded-full text-[1.05rem] font-semibold shadow-[0_0_20px_rgba(0,112,243,0.4)] hover:translate-y-[-2px] hover:shadow-[0_0_30px_rgba(0,112,243,0.6)] transition-all duration-400 flex items-center justify-center gap-3"
            >
