            ...
            <section className="pt-24 md:pt-32 pb-12 md:pb-16 px-6 border-b border-white/10 relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-6xl">
                    <FadeIn>
                        ...
                        <span className="text-xs text-brand-blue uppercase tracking-widest font-bold block mb-4">
                            {tag}
                        </span>

                        <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 leading-tight max-w-4xl">
                            {title}
                        </h1>
            ...
            <section className="py-16 md:py-20 border-t border-white/10">
                <div className="container mx-auto px-6 text-center">
                    <FadeIn>
                        ...
                        <p className="text-gray-400 mb-8 max-w-lg mx-auto">Let&apos;s discuss how we can build a system that drives real growth for your business.</p>
                        <Link
                            href="/#contact"
